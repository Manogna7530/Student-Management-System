...
?>                                    
                             ...
                             <table class="table table-bordered">
								...
								<tbody>
                                	<tr id="tr_adm_fee">
                                    	<td>1</td>
                                       	<td>Admission Fee</td>
                                        <td>Rs.<?php echo $admission_fee; ?></td>
                             ...
                             <div class="row">
                                <div class="col-xs-1 text-right pdetail1">
                                      <strong>
                                        <span id="spanaFee"><?php echo $admission_fee; ?>Rs.</span> 
                                        <span id="spanmFee"><?php echo $monthly_fee; ?>Rs.</span> <br>
										<span id="spanTotal"><?php echo $total; ?>Rs.</span> <br>
                                        <span id="spanPaid"><?php echo $total; ?>Rs.</span> <br>
                                      </strong>
  								</div>
