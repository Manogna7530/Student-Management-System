...
?>                                    
                            ...
                            <div class="row">
								<div class="col-xs-1 pdetail1">							
                       				<strong>
                                    	<span id="spanTotal">Rs.<?php echo $total_salary; ?></span> <br>
                                        <span id="spanAdvance">Rs.<?php echo $advance1; ?></span> <br>
			 							<span id="spanBalance">Rs.<?php echo $balance; ?></span> <br>
                                       	<span id="spanPaid">Rs.<?php echo $paid; ?></span> <br>
                                    </strong>
  								</div>
