...
?>                                    
                            ...
                            <div class="row">
                                <div class="col-xs-1 pdetail1">
                                      <strong>
                                        <span id="spanTotal1">Rs.<?php echo $total_salary; ?></span> <br>
                                        <span id="spanAdvance1">Rs.<?php echo $advance1; ?></span> <br>
										<span id="spanBalance1">Rs.<?php echo $balance; ?></span> <br>
                                        <span id="spanPaid1">Rs.<?php echo $paid; ?></span> <br>
                                      </strong>
  								</div>
