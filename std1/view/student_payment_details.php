...
?>                                            
                                            ...
                                            <tr>
                                                ...
                                                <td id="mFee_lMonth">Rs.<?php echo $last_paid;  ?></td>
                                              
                                            </tr>
                                            <tr>
                                                <td>Paid</td>
                                                <td id="lastPaid">Rs.<?php echo $last_paid;  ?></td>
                                            </tr>
                                            <tr>
                                                <td>Current Month</td>
...
?>                                            
                                                <td id="current_mFee">Rs.<?php echo $monthly_fee ?> </td>
                                            </tr>
                                            <tr>
                                                <td>Paid</td>
<?php
...
?>                                            
                                                <td id="currentPaid"> Rs.<?php echo $paid_current_month; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Due Amount </td>
                                                
                                                <td id="dueAmount">Rs.<?php echo $due; ?> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
